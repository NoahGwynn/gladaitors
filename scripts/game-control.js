// ============================================================================
// Game Control — interactive terminal controller for gladaitor
// ============================================================================
// Usage:
...
async function loadGame(gameKey, rounds = null) {
  ...
  try {
    ...
    const modelList = (result.models || []).map((m) => (typeof m === "string" ? m : `${m.name} (${m.model_id})`));
...
async function interactive(gameKey) {
  console.log("");
  console.log("  ⚔️  gladaitor — Game Control");
  console.log("  ─────────────────────────────");
