// ============================================================================
// Prompt Viewer — /game/trading-pit/prompt
// ============================================================================
// Displays the prompt templates sent to AI models for Trading Pit.
...
export default function TradingPitPromptPage() {
  const [data, setData] = useState<PromptData | null>(null);
  const [error, setError] = useState<string | null>(null);

  useEffect(() => {
    fetch(`${API_BASE}/prompts/trading_pit`)
      .then(res => res.json())
      .then(result => {
  ...
  return (
    <div className={styles.page}>
      <header className={styles.header}>
        <h1 className={styles.title}>Trading Pit — Prompt Templates</h1>
