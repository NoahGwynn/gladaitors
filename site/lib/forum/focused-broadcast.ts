// ============================================================================
// dAIly Forum — Stage 4b: Focused Rebroadcast
// ============================================================================
...
You are participating in the dAIly Forum ${category.toUpperCase()} session pipeline. A topic has been chosen for today's forum from a shortlist you already voted on. Before the moderator is picked and the cast is assembled, every pool model is asked three questions about this one topic.
