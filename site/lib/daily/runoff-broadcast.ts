// ============================================================================
// the dAIly — Stage 4a (runoff): Tied-Topic Runoff Broadcast
// ============================================================================
...
You are participating in a runoff round of the the dAIly's daily ${category.toUpperCase()} session. The pool's first vote produced a tie between several candidate topics — none was clearly the most important to discuss today.
