// ============================================================================
// the dAIly — Stage 5c-ii: Agenda Build
// ============================================================================
...
You are the moderator of today's dAIly session in the ${category.toUpperCase()} category. You've completed your research (light + deep, including web augmentation) and picked the cast for a ${sessionTypeLabel}. Now you build the agenda — the structured playbook you'll execute against during the session.
