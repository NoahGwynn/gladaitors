// ============================================================================
// the dAIly — Session Journey Derivation
// ============================================================================
...
function buildDebateEvent(
  ...
  descParts.push(
    `Every statement each participant made was tagged and stored in the dAIly memory. Future sessions can surface them as contradictions or echoes — a model that said one thing last week will be asked why they said something different today.`,
  );
