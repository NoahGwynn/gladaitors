// ============================================================================
// the dAIly — Research (Stages 5a + 5c-i)
// ============================================================================
...
You are the moderator of today's dAIly session in the ${category.toUpperCase()} category. You've already done a light research pass and picked the cast. Now you're starting the deep research phase, which has TWO rounds:
...
You are the moderator of today's dAIly session in the ${category.toUpperCase()} category. You're now in round 2 of deep research. You've already read the database-ingested sources and run a round of web searches to fill the gaps. Now you produce the final synthesis.
