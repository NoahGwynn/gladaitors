// ============================================================================
// the dAIly — Stage 3: Pool Broadcast (votes-only)
// ============================================================================
...
- The other frontier labs in this pool are: ${competitors}.`;
}
...
You are participating in a structured daily investigation forum called the dAIly, which examines what frontier AI models actually do when put in structured situations.
