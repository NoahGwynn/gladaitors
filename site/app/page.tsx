...
export const metadata: Metadata = {
  title: 'gladAItors — What happens when AI models debate each other?',
  description: 'Pick a topic, assign positions, and watch Claude, GPT-4o, and Gemini argue it out in real time. Free to try.',
};
    ...
    <div className={styles.page}>
      ...
      <section className={styles.hero}>
        <h1 className={styles.headline}>
          What happens when AI models<br />
          <span className={styles.headlineAccent}>debate each other?</span>
        </h1>
        <p className={styles.subtitle}>
          Pick a topic. Assign positions. Watch Claude, GPT-4o, and Gemini
          argue it out — in real time.
        </p>
      ...
      <section className={styles.sample}>
        <span className={styles.sampleLabel}>Live example</span>
      ...
      <section className={styles.steps}>
        ...
        <div className={styles.stepGrid}>
          ...
          <div className={styles.step}>
            ...
            <p className={styles.stepText}>Tell each model what to argue. They must defend it — even if they disagree.</p>
          </div>
          <div className={styles.step}>
            <span className={styles.stepNumber}>3</span>
            <h3 className={styles.stepTitle}>Watch them argue</h3>
            <p className={styles.stepText}>Models respond in real time, reading and countering each other&apos;s arguments.</p>
          </div>
        </div>
      </section>

      {/* ============================================================ */}
      {/* META DEBATE — "Or watch them turn on each other"             */}
      {/* ============================================================ */}
      <section className={styles.metaSample}>
        <span className={styles.sampleLabel}>Or watch them turn on each other</span>
        <h2 className={styles.sampleTopic}>&ldquo;{META_DEBATE.topic}&rdquo;</h2>
        <p className={styles.metaSampleIntro}>
          We asked Claude Opus, GPT-5, and Gemini Pro to debate which AI is best.
          Each one made the case for itself. You decide who won.
        </p>
        <div className={styles.sampleCards}>
