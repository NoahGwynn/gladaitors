// ============================================================================
// GET /api/daily/journey?category=ai&date=YYYY-MM-DD
// ============================================================================
// Returns the derived journey timeline for a single dAIly session.
...
import { deriveSessionJourney, type SessionRowForJourney } from '@/lib/daily/journey';
