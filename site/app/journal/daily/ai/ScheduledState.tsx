...
// of how the dAIly works for first-time visitors.
//
...
// dAIly. Instead we show the schedule and let readers choose when to
// arrive based on what they want to see.
//
// Times come from lib/daily/schedule.ts, which reads env vars that
    ...
    <div className={styles.scheduledWrap}>
      <div className={styles.scheduleCard}>
        ...
        <div className={styles.scheduleCardFooter}>
          All times in {SITE_TIMEZONE.replace('_', ' ')}. The debate is the live moment; the earlier stages are the process that built it.
        </div>
        {mostRecent && (
          <Link
            href={`/journal/daily/${category}/${mostRecent.session_date}`}
