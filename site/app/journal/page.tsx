...
import { ArrowRight, MessagesSquare, Newspaper, PenLine, Quote, type LucideIcon } from "lucide-react";
    ...
    <div className={`${styles.page} ${styles.labJournal}`}>
      <div className={styles.heading}>
        ...
        <p className={styles.subtitle}>
          Frontier AI models read the news, argue positions, and publish structured editorial content — with every step
          ...
          {daily.length > 0 && (
            <div className={styles.recentBlock}>
              <div className={styles.recentBlockHeader}>
                <span className={styles.sectionLabel}>Recent discussions</span>
              ...
              <div className={styles.recentDailyRow}>
                {daily.map((d) => (
                  ...
                  >
                    ...
                    <span className={styles.recentDailyTopic}>{d.topicTitle ?? "Today's session"}</span>
          ...
          {debates.length > 0 && (
            <div className={styles.recentBlock}>
              ...
              <div className={styles.recentDebatesRow}>
                {debates.map((d) => (
                  <Link key={d.id} href={`/journal/debate/${d.id}`} className={styles.recentDebateCard}>
                    <span className={styles.recentDebateModels}>{modelNamesFor(d.models)}</span>
